...
const welcomeText: LangString = {
    ...
    zh: "欢迎来到我的网站！我在这里写一些关于自己的东西和我想分享的事物。这是网站的最新版本，所以可能会有漏洞。您可以在右上角随意切换到不同的语言（英语、马来语、华语、粤语、法语、日语）！",
    ...
    jp: "私のウェブサイトへようこそ！ここで、自身のこととみんなさんにシェアしたい色々なことについてか書いています。このページは、新しいバージョンなので、バグがある可能性があります。右上隅でさまざまな言語（英語、マレー語、北京語、広東語、フランス語、日本語）に自由に切り替えてください。"
}
